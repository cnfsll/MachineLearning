...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 20 08:07:17 2017
...
np.save('train_acc_relu.npy', train_acc)
np.save('test_acc_relu.npy', test_acc_mean)
#画图
plt.plot(epoch, train_acc, 'r--', label='Train')
#plt.plot(epoch, valid_acc, 'b--', label='Valid')
plt.title('The change of accuracy as the epoch increases')
plt.ylabel('Accuracy')
plt.xlabel('epcoh')
plt.legend()
plt.show()
